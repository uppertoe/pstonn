...
func TestGoldenHTMLDocument(t *testing.T) {
	...
	got := []byte(htmlDocument("Visitor permit set to ABC123", body, "Not affiliated with the City of Stonnington.", "You received this at you@example.com because you hold the permit.", "https://p.stonn.org/u/addr/tok", Hero{Plate: "ABC123", Color: "#3b82f6"}))
