...
func templateRenderCases(loc *time.Location, user identity.User, tm Terms, now time.Time) []renderCase {
	return []renderCase{
		...
		{"schedule-picker-hint", dashboardData{User: user, State: "app", Page: "schedule", IsPrimary: true, Loc: loc,
			App: &appData{ShowPickerHint: true, Permits: []permitView{samplePermitViewAt(loc, now)}}}, "quick picker</a> on your phone does the same in one tap"},
		{"guests-page", dashboardData{User: user, State: "app", Page: "guests", IsPrimary: true, Loc: loc,
			...
			GuestMgmt: &guestMgmt{GuestsEnabled: true,
				...
				Guests: []guestGrantView{{ID: 1, Label: "Friday", PermitLabel: "Visitor Permit",
					...
					Recipients: []guestRecipientView{{TokenID: 9, Email: "dad@example.com"}}}}}}, "A visitor here now"},
		...
		{"guests-picker-edit", dashboardData{User: user, State: "app", Page: "guests", IsPrimary: true, Loc: loc,
			Vehicles: []vehicleView{{ID: 1, Label: "Mum", Registration: "AAA111", Color: "#111"}, {ID: 2, Label: "Dad", Registration: "AAA222", Color: "#222"}},
			GuestMgmt: &guestMgmt{GuestsEnabled: true, PermitOpts: []permitOpt{{ID: 1, Label: "Visitor Permit"}},
				PickerCard: &pickerCardView{Open: true, PermitOpts: []permitOpt{{ID: 1, Label: "Visitor Permit"}},
					Vehicles: []vehicleView{{ID: 1, Label: "Mum", Registration: "AAA111", Color: "#111"}, {ID: 2, Label: "Dad", Registration: "AAA222", Color: "#222"}},
		...
		{"guest-picker-menu", dashboardData{State: "guest", Loc: loc, Guest: guestActView{
			Token: "tok", Picker: true, Household: "the Helds", Council: "City of Stonnington", PermitLabel: "Home permit", CurrentReg: "ABC123", MineReg: "ABC123", RevertPlate: "1QT4RM", CheckedAt: 1700000000,
			Cars: []vehicleView{
		...
		{"guest-menu-last-known", dashboardData{State: "guest", Loc: loc, Guest: guestActView{
			Token: "tok", Household: "the Helds", Council: "City of Stonnington", PermitLabel: "Visitor Permit", CurrentReg: "ABC123", MaskedReg: "••••23", CheckedAgo: "4 hr ago", CheckedAt: 1700000000,
			Cars: []vehicleView{{ID: 1, Label: "Mum", Registration: "AAA111", Color: "#111"}}, AllowOvernight: true}}, "checked 4 hr ago"},
