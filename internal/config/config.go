...
type Config struct {
	...
	TermsPath string
	// TenantsPath optionally points at a councils registry file (the shape of
	// internal/tenant/tenants.json) to use instead of the embedded one.
	TenantsPath string
...
func Load() (*Config, error) {
	...
	cfg := &Config{
		...
		TenantsPath:   strings.TrimSpace(os.Getenv("TENANTS_PATH")),
